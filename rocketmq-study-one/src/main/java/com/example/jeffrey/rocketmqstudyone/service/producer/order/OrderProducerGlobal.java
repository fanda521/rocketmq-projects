...
public class OrderProducerGlobal {
    public static void main(String[] args) throws Exception {
        // 1. 创建生产者
        DefaultMQProducer producer = new DefaultMQProducer(RocketMQConstant.PRODUCER_GROUP_GLOBAL);
                ...
                try {
                    for (String step : orderSteps) {
                        ...
                        Message msg = new Message(
                                RocketMQConstant.TOPIC_GLOBAL,       // Topic
                                "OrderTag",         // Tag
